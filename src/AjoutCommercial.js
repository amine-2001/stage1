...
class AjoutCommercial extends Component {
    constructor(props) {
        super(props);
        this.state = {
            nom: '',
    ...
    ajout = () => {
        jQuery.ajax({
            url: process.env.REACT_APP_API_URL + 'Back_hooda/AddCommercial.php',
            type: 'POST',
            data: {
                nom: this.state.nom,
                tel: this.state.tel,
                ...
                <div className="container-fluid">
                    <div className="row bg-title">
                        <div className="col-lg-12">
                            <h4 className="page-title">Ajout commercial</h4>
                        </div>
                        {/* /.col-lg-12 */}
                    </div>
                    {/* /.row */}
...
export default withRouter(AjoutCommercial);