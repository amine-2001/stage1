...
$query = "SELECT lignedevis.*, article.nom_article AS nomarticle,article.Montant_Article AS Montant,article.format AS format,article.poids AS poids,article.papier AS papier,article.prepresse AS prepresse,article.impression AS impression,article.finition AS finition,article.faconnage AS faconnage,article.paquetage AS paquetage,article.livraison AS livraison 
          FROM lignedevis 
