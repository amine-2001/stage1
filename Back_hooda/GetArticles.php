...
// data
$query = "SELECT * FROM article WHERE (UPPER(nom_article) LIKE '%" . $filter . "%') LIMIT $debut,$nbr_element_page";
...
// number data
$query = "SELECT COUNT(*) FROM article WHERE (UPPER(nom_article) LIKE '%" . $filter . "%')";
$affichage = mysqli_query($connect, $query) or die(mysqli_error($connect));
