...
class SMTP { 
    ...
    // De Qui
    var $From = 'nesrine@mtd-application.com';// Adresse de l' exp�diteur
    var $FromName = 'Gerajeune';// Nom de l' exp�diteur
    var $ReplyTo = 'nesrinederbel@gmail.com';// Adresse de retour
    var $org = 'Gerajeune'; // Organisation



    // A Qui
    var $To = 'houcemdzr@gmail.com';
    ...
    var $serveur = 'mail.internet-soft.biz';// Serveur SMTP
    var $port = 587;// Port SMTP
    var $login_smtp = 'info@internet-soft.biz';// Login pour le serveur SMTP
    var $mdp_smtp = '123456';// Mot de passe pour le serveur SMTP
